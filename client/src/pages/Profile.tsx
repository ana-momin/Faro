...
import { ArrowRight, BadgeCheck, Bot, Camera, Compass, LockKeyhole, LogOut, Radar, ShieldCheck, Sparkles, UserRound } from "lucide-react";
...
export default function Profile() {
  ...
  return <DashboardLayout><div className="mx-auto max-w-5xl pb-10">
