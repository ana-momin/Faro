...
export default function Search() {
  ...
  const finish = (data: { sync?: { inserted: number } | null; sourceStatus: string; syncError?: string | null }) => {
    ...
    // Discover refreshes in the background so it never delays the finished
    // source-check state after a controlled search is complete.
