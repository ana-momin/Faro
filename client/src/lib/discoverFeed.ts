...
const CONCRETE_BUYER_ACTION = "(looking for (?:someone|a freelancer|an? agency|a developer|an? engineer|a tester|a product tester|a designer|a creator|an? editor|an? expert|an? consultant)|looking to hire|need(?:s)? (?:someone|a freelancer|an? agency|a developer|an? engineer|a tester|a product tester|a designer|a creator|an? editor|an? expert|an? consultant|a team)|need(?:s)? (?:help|a hand) (?:building|automating|implementing|setting up|creating|integrating)|seeking (?:a provider|an? expert)|can someone (?:build|set up|implement)|who can (?:build|help us)|recommend (?:someone|a freelancer|an? agency)|does anyone know an? (?:developer|agency|freelancer|consultant)|anyone know an? (?:developer|agency|freelancer)|recommendations for an? (?:developer|agency|freelancer)|looking to outsource|hire (?:a |an ))";
...
const OPENING_BUYER_REQUEST = /^\s*(?:looking for (?:someone|a freelancer|an? agency|a developer|an? engineer|a tester|a product tester|a designer|a creator|an? editor|an? expert|an? consultant)|looking to hire\b|need(?:s)? (?:someone|a freelancer|an? agency|a developer|an? engineer|a tester|a product tester|a designer|a creator|an? editor|an? expert|an? consultant|a team)|need(?:s)? (?:help|a hand)\b|seeking (?:a provider|an? expert)|can someone (?:build|set up|implement)\b|who can (?:build|help us)\b|recommend (?:someone|a freelancer|an? agency)|does anyone know an? (?:developer|agency|freelancer|consultant)|anyone know an? (?:developer|agency|freelancer)|recommendations for an? (?:developer|agency|freelancer)|looking to outsource\b|hire (?:a |an ))/i;
