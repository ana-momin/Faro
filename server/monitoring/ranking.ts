...
const DIRECT_BUYER_SUBJECT_PATTERN = /\b(i|we|our|my|team|company|business|founder|client)\b.{0,90}\b(looking for|need someone|need a freelancer|need an agency|need a developer|need an engineer|need a tester|need a product tester|need a designer|need a creator|need an editor|need an expert|need help|seeking|can someone|who can|recommend|hire)\b/;
const OPENING_BUYER_ASK_PATTERN = /^\s*(looking for|need someone|need a freelancer|need an agency|need a developer|need an engineer|need a tester|need a product tester|need a designer|need a creator|need an editor|need an expert|need help|seeking|can someone|who can|recommend|hire)\b/;
