...
const DIRECT_SERVICE_REQUEST_PATTERNS = ["looking for someone", "looking for a freelancer", "looking for an agency", "looking for a developer", "looking for an engineer", "looking for a tester", "looking for a product tester", "looking for a designer", "looking for a creator", "looking for an editor", "looking to hire", "need someone", "need a freelancer", "need an agency", "need a developer", "need an engineer", "need a tester", "need a product tester", "need a designer", "need a creator", "need an editor", "need an expert", "need a consultant", "needs someone", "needs a freelancer", "needs an agency", "needs a developer", "needs a tester", "needs an expert", "needs a consultant", "need help with", "need help building", "need a hand with", "needs help with", "needs help building", "can someone build", "can someone set up", "can someone implement", "who can build", "who can help us", "recommend someone", "recommend a freelancer", "recommend an agency", "seeking a provider", "seeking an expert", "looking to outsource", "need a team to", "needs a team to", "does anyone know a developer", "does anyone know an agency", "does anyone know a freelancer", "does anyone know a consultant", "anyone know a developer", "anyone know an agency", "anyone know a freelancer", "recommendations for a developer", "recommendations for an agency", "hire a"];
...
const DIRECT_BUYER_SUBJECT_PATTERN = /\b(i|we|our|my|team|company|business|founder|client)\b.{0,90}\b(looking for|need someone|need a freelancer|need an agency|need a developer|need an engineer|need a tester|need a product tester|need a designer|need a creator|need an editor|need an expert|need help|need a hand|seeking|can someone|who can|recommend|hire)\b/;
const OPENING_BUYER_ASK_PATTERN = /^\s*(looking for|need someone|need a freelancer|need an agency|need a developer|need an engineer|need a tester|need a product tester|need a designer|need a creator|need an editor|need an expert|need help|need a hand|seeking|can someone|who can|recommend|hire|does anyone know a (developer|agency|freelancer|consultant)|anyone know a (developer|agency|freelancer)|recommendations for an? (developer|agency|freelancer))\b/;
